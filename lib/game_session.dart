...
class GameSession {
 ...
 void addPlayer(String name) {
  ...
  void playerPlays(PlayableWord word) {
    ...
    players[localPlayer].rack = List.from(playerRack.letters);
...
class LetterBag {
  ...
  Map<String, dynamic> toJson() =>  {'letters': _letters};
